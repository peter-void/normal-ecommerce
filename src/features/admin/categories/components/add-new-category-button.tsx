...
import { Plus, X, Image as ImageIcon, Calendar, Sparkles } from "lucide-react";
            ...
            <div className="p-8 pt-4 border-t-2 border-border flex gap-4 bg-secondary-background/30">
              <DialogClose asChild>
                <Button
                  type="button"
                  variant="neutral"
                  className="flex-1 h-14 font-heading text-lg border-2 border-border bg-white text-black shadow-[4px_4px_0px_0px_rgba(0,0,0,1)] hover:bg-red-50 active:translate-x-[2px] active:translate-y-[2px] active:shadow-none"
                >
                  DISCARD
                </Button>
              </DialogClose>
            ...
            <div className="relative z-10 w-full space-y-6">
                ...
                <div className="p-5 text-left space-y-3">
                  ...
                  <p className="text-xs text-muted-foreground line-clamp-2 italic leading-relaxed">
                    {watchedValues.description ||
                      "Start typing your description to see how it looks here..."}
                  </p>
                  <div className="pt-2">
                    <Badge
                      variant="neutral"
              ...
              <div className="bg-white/50 backdrop-blur-sm border-2 border-dashed border-border p-4 rounded-base">
                <p className="text-xs font-base text-muted-foreground">
                  The card above demonstrates how this category will appear in
