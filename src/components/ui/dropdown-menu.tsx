...
function DropdownMenuItem({
  ...
  return (
    <DropdownMenuPrimitive.Item
      ...
      data-inset={inset}
      className={cn(
        "relative gap-2 [&_svg]:pointer-events-none [&_svg]:w-4 [&_svg]:h-4 [&_svg]:shrink-0 flex cursor-default select-none items-center rounded-sm border-0 data-[inset=true]:pl-8 bg-white text-black px-2 py-1.5 text-sm font-base outline-hidden transition-colors focus:bg-gray-100 focus:text-black data-disabled:pointer-events-none data-disabled:opacity-50",
        className,
      )}
      {...props}
    />
